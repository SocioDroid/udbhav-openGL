...
*/
    ...
    // float red = 64.0 / 255.0;
    // float green = 191.0 / 255.0;
    // float blue = 219.0 / 255.0;

    // version 1
    // float red = 54.0 / 255.0;
    // float green = 90.0 / 255.0;
    // float blue = 143.0 / 255.0;

    // Version 2
    // float red = 45.0 / 255.0;
    // float green = 74.0 / 255.0;
    // float blue = 119.0 / 255.0;
    ...
    else
    {
        ...
        green = 63.0 / 255.0;
        blue = 25.0 / 255.0;
        waterColor = color + vec4(specularHighlights, 0.0) ;
    }
