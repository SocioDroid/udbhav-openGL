...
layout( location = 0 )  in vec4 a_positionMass;
layout( location = 1 )  in vec4 a_previousPosition;
...
const vec3 center1 = vec3(0.0, 1.9, 0.5);
//const vec3 center1 = vec3(0.0, 2.1, 0.8);

const float radius1 = 1.8;
//const float radius1 = 2.0;

const vec3 center2 = vec3(0.0, 4.7, 0.05);
...
/*
	if(index == 160 || index == 161 || index == 162 || index == 163 || index == 164 || index == 165 ||
	index == 224 || index == 225 || index == 226 || index == 227 || index == 228 || index == 229 ||
	index == 288 || index == 289 || index == 290 || index == 291 || index == 292 || index == 293)
	{
		mass = 0.0;
	}

	if(index == 32 || index == 33 || index == 34 || index == 35 || index == 36 || index == 37 ||
	index == 96 || index == 97 || index == 98 || index == 99 || index == 100 || index == 101 ||
	index == 160 || index == 161 || index == 162 || index == 163 || index == 164 || index == 165 ||
	index == 224 || index == 225 || index == 226 || index == 227 || index == 228 || index == 229 ||
	index == 288 || index == 289 || index == 290 || index == 291 || index == 292 || index == 293)
	{
		mass = 0.0;
...
*/
	...
	index == 96 || index == 97 || index == 98 ||
	index == 160 || index == 161 || index == 162 ||
	index == 224 || index == 225 || index == 226 ||
	index == 288 || index == 289 ||  index == 290 || index == 291 || index == 292 || index == 293 ||
	index == 352 || index == 353 || index == 354 || index == 355 || index == 356 || index == 357 ||
	index == 416 || index == 417 || index == 418 || index == 419 || index == 420 || index == 421)
	{
		mass = 0.0;
	}

	vec3 windVector = vec3(0.0f, 0.0f, -3.0f);
	vec3 force = u_gravity * mass + windVector * (u_defaultDamping * velocity);
	...
	sphereCollision(position, center1, radius1);
//	sphereCollision(position, center2, radius2);
