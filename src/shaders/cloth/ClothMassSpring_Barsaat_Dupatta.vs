...
/*
const vec3 center1 = vec3(-0.5, 1.0f, 2.4);
const float radius1 = 0.75;
*/

const vec3 center1 = vec3(0.0, 2.5, 2.35);
const float radius1 = 0.4;

const vec3 center2 = vec3(0.0, 2.6, 1.9);
const float radius2 = 0.4;

const vec3 center3 = vec3(0.0, 2.6, 1.65);
const float radius3 = 0.4;

const vec3 center4 = vec3(0.0, 2.75, 2.2);
const vec3 center5 = vec3(0.0, 2.75, 1.7);
const float radius4 = 0.25;
...
void main(void)
{
	...
	for(int i = 0; i < (u_texSizeX * u_texSizeY); i++)
	{
		if(i >= (1024 - 64) && i < 1024)
		{
			if(index == i)
		...
		vec3 windForce = vec3(0.0, 0.0, -3.0);
		...
		if(u_dupattaFall == 0)
		{
			...
			sphereCollision(position, center3, radius3);
		}
		else
		{
			sphereCollision(position, center4, radius4);
			sphereCollision(position, center5, radius4);
		}
